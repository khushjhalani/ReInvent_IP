...
var Car = /** @class */ (function () {
    ...
    Car.prototype.age = function () {
        var date = new Date();
        console.log("This car is ".concat(date.getFullYear() - this.year, " years old"));
    };
    Car.prototype.acclerate = function () {
        this.speed += 20;
        console.log("Acclerated 20kmph.\n New speed ".concat(this.speed, "."));
    };
    return Car;
}());
var sportsCar = /** @class */ (function (_super) {
    ...
    sportsCar.prototype.acclerate = function () {
        this.speed += 50;
        console.log("Acclerated 50 kmph \n New speed: ".concat(this.speed));
    };
    return sportsCar;
}(Car));
var myCar = new Car("Ford", 2014, 0);
var myCar2 = new sportsCar("Audi", 2019, 0);
myCar.age();
myCar.acclerate();
myCar.acclerate();
myCar2.acclerate();
